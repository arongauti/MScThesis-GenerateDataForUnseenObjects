...
\begin{figure}[h]
    \centering
    \subfloat[Highest IoU score, nr. 115]{\includegraphics[width=0.4\textwidth]{graphics/results/v1Best.png}}
    \hspace{0.5cm}
    \subfloat[Lowest IoU score, nr. 49]{\includegraphics[width=0.4\textwidth]{graphics/results/v1Worst.png}}
...
\begin{figure}[h]
    \centering
    % include first image
    \subfloat[Intersubsection over Union]{\includegraphics[width=0.5\textwidth, trim={0.5cm 0 1.5cm 0},clip]{graphics/results/iouboxplotForProducts.png}\label{fig:unknownioua}}
    \hfill
