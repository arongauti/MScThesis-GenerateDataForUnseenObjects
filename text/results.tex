...
\subsection*{Tests}
Robot manipulator performance was measured by making four tests and taking time, iterations and interventions. The performance can been seen in Table \ref{tab:testonrobot}.
...
As can been in the Figure \ref{figure: imagework} this would not work so another method would be needed to find the right bounding box automatically. That method is described in methods in Section \ref{sec:difference}.
