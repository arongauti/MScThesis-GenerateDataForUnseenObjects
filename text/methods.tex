...
\begin{figure}[ht]
    ...
    \hfill
    \subfloat[Completed end effector mounted on the robot]{\includegraphics[width=0.3\textwidth]{graphics/methods/rani1.jpg}}
    \hfill
    \subfloat[The end effector extended by 14cm]{\includegraphics[width=0.3\textwidth]{graphics/methods/rani2.jpg}\label{figure: newendeffector}}
...
\begin{figure}[h]
    \centering
    % include first image
    \subfloat[RGB image]{\includegraphics[width=0.35\textwidth,trim={4cm 0 4cm 0},clip]{graphics/methods/color_Color.png}\label{fig:l515depth}}
    \hfill
    \subfloat[Depth image]{\includegraphics[width=0.3\textwidth]{graphics/methods/depth_Depth.png}\label{fig:l515color}}
    \hfill
    \subfloat[The camera coordinates system]{\includegraphics[width=0.28\textwidth]{graphics/lidar515.jpg}\label{fig:l515cor}}
...
\begin{figure}[h]
    \centering
    % include first image
    \subfloat[Alberto Balsam ]{\includegraphics[width=0.37\textwidth]{graphics/methods/b0001.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat[Nivea Cleansing Milk]{\includegraphics[width=0.37\textwidth]{graphics/methods/b0144.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat[Nivea Elastic]{\includegraphics[width=0.37\textwidth]{graphics/methods/b0209.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat[Nivea Texture]{\includegraphics[width=0.37\textwidth]{graphics/methods/b0358.png}}
...
\begin{figure}[h]
    \centering
    % include first image
    \subfloat{\includegraphics[width=0.37\textwidth]{graphics/results/0000.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat{\includegraphics[width=0.37\textwidth]{graphics/results/0001.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat{\includegraphics[width=0.37\textwidth]{graphics/results/0027.png}}
    %\hfill
    \hspace{2 cm}
    \subfloat{\includegraphics[width=0.37\textwidth]{graphics/results/0028.png}}
    \hspace{2 cm}
    \subfloat{\includegraphics[width=0.37\textwidth]{graphics/results/0146.png}}
    %\hfill
    \hspace{2 cm}
