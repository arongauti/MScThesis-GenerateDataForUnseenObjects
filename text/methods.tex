...
\begin{figure}[h]
    \centering
    % include first image
    \subfloat[Alberto Balsam ]{\includegraphics[width=0.45\textwidth]{graphics/methods/b0001.png}}
    \hfill
    \subfloat[Nivea Cleansing Milk]{\includegraphics[width=0.45\textwidth]{graphics/methods/b0144.png}}
    \hfill
    \subfloat[Nivea Elastic]{\includegraphics[width=0.45\textwidth]{graphics/methods/b0209.png}}
    \hfill
    \subfloat[Nivea Texture]{\includegraphics[width=0.45\textwidth]{graphics/methods/b0358.png}}
