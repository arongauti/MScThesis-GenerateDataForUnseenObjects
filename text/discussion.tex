...
% The goal of this thesis was to answer the question is it possible to use a robot to generate training data for previously unseen objects. To be able to answer this question few experiments were done, for each research question.
...
% Data were collected from both former students and by the author himself by having the robot pick up objects and move them repeatedly.